...
# C:\Users\uidr8549\Envs\tracker-tf-cpu-py35\python.exe runner.py by-dataset
import os
...
class ADNetRunner:
    ...
    def tracking(self, img, curr_bbox, idx):
        # print("---------------------tracking")
        self.iteration += 1
        is_tracked = True
        boxes = []
        ...
        gt_boxes = BoundingBox.read_vid_gt('./data/LT52/', idx)
